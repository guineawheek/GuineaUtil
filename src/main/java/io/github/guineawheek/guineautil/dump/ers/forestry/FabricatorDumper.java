    ...
    public JSONObject dump(ICraftingHandler handler) {
        ...
        for (IFabricatorRecipe recipe : RecipeManagers.fabricatorManager.recipes()) {
            JSONObject jsonRecipe = new JSONObject()
                ...
                .put("plan", (recipe.getPlan() == null) ? JSONObject.NULL : JSONUtil.encodeItemStack(recipe.getPlan()))
                .put("liquid", (recipe.getLiquid() == null)  ? JSONObject.NULL : JSONUtil.encodeFluidStack(recipe.getLiquid()))
                ;
